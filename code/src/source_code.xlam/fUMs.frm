VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} fUMs 
   Caption         =   ":: Cadastro de Unidades de Medida ::"
   ClientHeight    =   9105
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   9960
   OleObjectBlob   =   "fUMs.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "fUMs"
...
Private Sub lstPrincipal_Change()
    ...
    If lstPrincipal.ListIndex >= 0 Then
        ...
        With oUM
            ...
            lblCabAbreviacao.Caption = .Abreviacao
            txbAbreviacao.Text = .Abreviacao
...
Private Sub Campos(Acao As String)
    ...
    If Acao <> "Limpar" Then
        ...
        txbAbreviacao.Enabled = b: lblAbreviacao.Enabled = b
        txbDescricao.Enabled = b: lblDescricao.Enabled = b
        
    Else
    
        lblCabID.Caption = ""
        lblCabAbreviacao.Caption = ""
        lblCabDescricao.Caption = ""
        txbAbreviacao.Text = Empty
        txbDescricao.Text = Empty
...
Private Sub lstPrincipalPopular(Pagina As Long)
    ...
    With lstPrincipal
        ...
        .ColumnWidths = "40pt; 60 pt; 180pt;"       ' Configura largura das colunas
        ...
        While Not myRst.EOF = True And n <= myRst.PageSize
            ...
            .List(.ListCount - 1, 1) = myRst.Fields("abreviacao").Value
            .List(.ListCount - 1, 2) = myRst.Fields("descricao").Value
...
Private Sub Gravar(Decisao As String)
    ...
    If vbResposta = vbYes Then
        ...
        If Decisao <> "Exclusão" Then
            ...
            If txbAbreviacao.Text = Empty Then
                MsgBox "Campo 'Abreviação' é obrigatório", vbCritical: MultiPage1.Value = 1: txbAbreviacao.SetFocus
            Else
        ...
        Else ' Se for exclusão
            ...
            oUM.CRUD eCrud.Delete, oUM.ID, Decisao
...
Private Sub BuscaRegistros(Optional Ordem As String)
    ...
    Set myRst = oUM.Todos(Ordem, txbFiltro.Text)
...
Private Sub lblHdAbreviacao_Click(): Call BuscaRegistros("abreviacao"): End Sub
Private Sub lblHdDescricao_Click(): Call BuscaRegistros("descricao"): End Sub

Private Sub lblFiltrar_Click()

    oGlobal.Tabela = "tbl_ums" ' Pode ser uma tabela ou consulta
